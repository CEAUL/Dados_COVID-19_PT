...
cvwd <- rDat[, `:=`(data2 = as.Date(data, format = "%d-%m-%Y"),
  ...
  , `:=`(Date = format(data2, "%a %d %b %Y"),
         ...
         New_Cases = sprintf("%+d", confirmados_novos),
...
useVars <- c("Date", "Cases_7_Day_Mean", "New_Cases", "Active_Cases", "Deaths_7_Day_Mean", "Deaths")
cvwd[, tail(.SD, 10)][
    , ..useVars]  %>%
  kable(align = c("rrrrrr"), 
        table.attr ="class=\"striped\"",
        col.names = c("Date", "Cases 7 Day Mean", "New Cases", "Active Cases",
                      "Deaths 7 Day Mean", "Deaths"))
```
