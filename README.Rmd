...
# useVars <- c("Date", "confirmados_novos", "confirmados", "ativos", "recuperados", "obitos_novos", "obitos")
...
cvwd[, tail(.SD, 10)][
    , ..useVars]  %>%
  kable(align = c("rrrrrr"), caption = "Change from previous day in brackets.",
